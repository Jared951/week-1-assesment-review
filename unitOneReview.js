...
if (num % 2 === 0) {
    ...
    // or console.log('num is not an even number')
}
...
for (let i = 0; i < price.length; i++) {
    // totalPrice = totalPrice + 5 same way of doing it
    totalPrice += price [i]
...
/* 
    Loop through the colors array above. 
    Then, print 'apple' if the color is red, 
    print 'melon' if the color is green, 
    and print 'banana' when the color is yellow.
*/
